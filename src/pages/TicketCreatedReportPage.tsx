/**
 * @file TicketCreatedReportPage.tsx
 * @description Reporte superadmin de tickets creados por correo (app_logs).
 */
import { History } from "lucide-react";
import { TicketCreatedReportFilters } from "@/components/reports/TicketCreatedReportFilters";
import { TicketCreatedReportTable } from "@/components/reports/TicketCreatedReportTable";
import { Button } from "@/components/ui/button";
import { EmptyState } from "@/components/ui/empty-state";
import { Loading } from "@/components/ui/loading";
import { Select } from "@/components/ui/select";
import { useTicketCreatedReport } from "@/hooks/useTicketCreatedReport";
import {
...
/**
 * Vista de reporte de logs ticket.created con filtros, tabla y paginación.
 * @returns Página del reporte superadmin.
 */
export default function TicketCreatedReportPage() {
  const {
    items,
    filters,
    setFilters,
    ...
    <div className="space-y-5">
      <div>
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-semibold">Tickets creados por IA</h1>
        </div>
        <p className="mt-1 text-sm text-muted-foreground">
          Registros del evento ticket.created en app_logs.
        </p>
      </div>

      <TicketCreatedReportFilters
        filters={filters}
        onChange={setFilters}
